...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function addEventListeners(modal) {
            ...
            if (boatSelect) boatSelect.addEventListener('change', function() {
                updateTotalPrice(modal);
            });
            if (adultsInput) adultsInput.addEventListener('input', function() {
                updateTotalPrice(modal);
            });
            if (teensInput) teensInput.addEventListener('input', function() {
                updateTotalPrice(modal);
            });
            if (toddlersInput) toddlersInput.addEventListener('input', function() {
                updateTotalPrice(modal);
            });
            if (promoSelect) promoSelect.addEventListener('change', function() {
                updateTotalPrice(modal);
            });
            if (extraSelect) extraSelect.addEventListener('change', function() {
                updateTotalPrice(modal);
            });
        }
